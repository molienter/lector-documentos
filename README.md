...
Este proyecto está en una etapa muy temprana, ya que, se ha utilizado para automatizar ciertos trabajos de búsqueda de información y categorización de PDFs, pero realmente cumple con su funcionalidad principal, a falta de modificar el código complementario utilizado para buscar y tratar la información, según las necesidades del usuario específico al que se destine el programa.
